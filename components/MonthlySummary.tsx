    ...
    <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-blue-50 rounded-lg">
          <div className="text-sm text-gray-600 mb-1">Total Spent by Me</div>
          <div className="text-2xl font-bold text-blue-900">₹{totalSpentByMe.toFixed(2)}</div>
        </div>

        <div className="p-4 bg-purple-50 rounded-lg">
          <div className="text-sm text-gray-600 mb-1">Spent for Others</div>
          <div className="text-2xl font-bold text-purple-900">₹{totalSpentForOthers.toFixed(2)}</div>
        ...
        <div className="p-4 bg-green-50 rounded-lg">
          <div className="text-sm text-gray-600 mb-1">Net Amount (Me + Pending)</div>
          <div className="text-2xl font-bold text-green-900">₹{netAmount.toFixed(2)}</div>
        </div>
