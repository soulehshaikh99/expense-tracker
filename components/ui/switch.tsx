...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary dark:data-[state=checked]:bg-blue-600 data-[state=checked]:border-transparent data-[state=unchecked]:bg-input dark:data-[state=unchecked]:bg-gray-700 data-[state=unchecked]:border-gray-300 dark:data-[state=unchecked]:border-gray-600 data-[state=unchecked]:hover:border-gray-400 dark:data-[state=unchecked]:hover:bg-gray-600 dark:data-[state=unchecked]:hover:border-gray-500",
      className
    )}
    {...props}
    ref={ref}
